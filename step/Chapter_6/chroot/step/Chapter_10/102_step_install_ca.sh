...
CERDATA="certdata"
CERDATA_SRC_FILE="$CERDATA.txt"

if [ ! -f /sources/$CERDATA_SRC_FILE ]; then
   wget -O /sources/$CERDATA_SRC_FILE $REPOSITORY/$CERDATA_SRC_FILE
fi

mv /sources/$CERDATA_SRC_FILE /tmp/
make-ca.sh
